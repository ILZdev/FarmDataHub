  ...
  timun: [
    {
      ...
      description:
        "Dokumentasi penanaman benih timun varietas hibrida pada media tanam yang telah disiapkan. Benih ditanam dengan kedalaman 2-3 cm dan jarak tanam 30x40 cm. Kondisi tanah dalam keadaan lembab dengan pH 6.0-6.8. Suhu lingkungan sekitar 25-30°C dengan kelembaban udara 70-80%. Penyiraman dilakukan secara hati-hati untuk menjaga kelembaban tanah tanpa menyebabkan genangan air.",
      weather: "Cerah, 28°C",
      notes:
    ...
    },
    {
      ...
      description:
        "Video dokumentasi penyiraman rutin pada hari kedua setelah penanaman. Penyiraman dilakukan pada pagi hari menggunakan sprayer halus untuk menghindari erosi tanah. Pemeriksaan kondisi media tanam dan tanda-tanda perkecambahan awal. Suhu tanah diukur dan dijaga pada kisaran optimal 24-26°C.",
...
if (window.elementSdk) {
  window.elementSdk.init({
    ...
    onConfigChange: async (config) => {
      ...
      if (titleElement) {
        titleElement.textContent =
          config.site_title || defaultConfig1.site_title;
      }
      if (descElement) {
        descElement.textContent =
          config.site_description || defaultConfig1.site_description;
      }
    },
    ...
    mapToEditPanelValues: (config) =>
      new Map([
        ["site_title", config.site_title || defaultConfig1.site_title],
        [
          "site_description",
          config.site_description || defaultConfig1.site_description,
        ],
  ...
  modalContent.innerHTML = `
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg">
                        <h4 class="font-semibold text-gray-800 mb-2">🌤️ Kondisi Lingkungan</h4>
                        <div class="space-y-2 text-sm">
                ...
                <div class="bg-green-50 p-4 rounded-lg mb-6">
                    <h4 class="font-semibold text-gray-800 mb-3">📝 Deskripsi Lengkap</h4>
                ...
                <div class="bg-yellow-50 p-4 rounded-lg">
                    <h4 class="font-semibold text-gray-800 mb-3">💡 Catatan Lapangan</h4>
...
function updateNavigation() {
  ...
  if (currentPeriod === "daily") {
    ...
    availableValues.forEach((dateValue, index) => {
      ...
      btn.textContent = `Hari ${index + 1} (${new Date(dateValue).getDate()}/${
                          ...
                          item
                            ...
                            <div class="p-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-xs bg-red-100 text-red-800 px-2 py-1 rounded-full">📹 Video</span>
                                </div>
                                ...
                                <div class="mt-2 text-xs text-blue-600 font-medium">👆 Klik untuk detail lengkap</div>
                            </div>
                        </div>
                    `;
      } else {
          ...
          commodityNames[item.commodity]
                            ...
                            <div class="p-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">📷 Foto</span>
                                </div>
                                <h3 class="text-sm font-medium text-gray-800 mb-1 line-clamp-2">${
                                  item.title
                                }</h3>
                                ...
                                <div class="mt-2 text-xs text-green-600 font-medium">👆 Klik untuk detail lengkap</div>
                            </div>
                        </div>
                    `;
      }
